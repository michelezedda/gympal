...
function Hero() {
  ...
  return (
    <>
      <div className="flex relative h-[100dvh] bg-[url(/media/background.webp)] bg-center lg:bg-left bg-cover bg-no-repeat">
        <div className="absolute bottom-0 left-0 w-full h-3/4 bg-gradient-to-b from-transparent to-neutral-950" />
        <div className="flex flex-col justify-center items-start top-16 border-neutral-500 lg:border-r-2 lg:border-b-2 lg:h-[90dvh] lg:w-[80dvw] shadow-2xl lg:shadow-black brightness-130">
          <h1 className="flex flex-col text-6xl md:text-7xl leading-18 md:leading-22 text-lime-600 font-black shadow-md font-[Rubik_Glitch] ml-20 lg:mr-20">
            SCULPT YOUR BODY,
            <br />
            ELEVATE YOUR SOUL
          </h1>
          <div className="flex mt-16 gap-6 font-semibold ml-21">
            <button
          ...
          <div className="hidden lg:absolute lg:flex lg:flex-col lg:bottom-2 lg:-right-15 lg:gap-2">
            <Link
              ...
              className=" rounded-full bg-neutral-400 p-3 text-black hover:text-white hover:bg-lime-600 duration-300 ease-in-out"
            >
              <FaSquareFacebook
